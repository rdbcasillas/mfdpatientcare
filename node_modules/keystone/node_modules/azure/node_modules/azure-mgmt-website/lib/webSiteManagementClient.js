...
var WebSiteManagementClient = ( /** @lends WebSiteManagementClient */ function() {
  ...
  WebSiteManagementClient.prototype.getOperationStatus = function(webSpaceName, siteName, operationId, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.credentials.subscriptionId ? this.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + siteName.trim() + '/operations/' + operationId.trim();
...
var ServerFarmOperations = ( /** @lends ServerFarmOperations */ function() {
   ...
   * 
   * @param {ServerFarmStatus} [parameters.status] The server farm status.
   * Possible values are Ready or Pending.
   * 
   * @param {function} callback
   * 
   * @returns {Stream} The response stream.
  ...
  ServerFarmOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms';
  ...
  ServerFarmOperations.prototype.delete = function(webSpaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms/DefaultServerFarm';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  ServerFarmOperations.prototype.get = function(webSpaceName, serverFarmName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/ServerFarms/' + serverFarmName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
...
var WebSiteOperations = ( /** @lends WebSiteOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  WebSiteOperations.prototype.beginSwapingSlots = function(webSpaceName, webSiteName, sourceSlotName, targetSlotName, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '(' + sourceSlotName.trim() + ')/slots?';
    url2 = url2 + 'Command=swap';
    url2 = url2 + '&targetSlot=' + encodeURIComponent(targetSlotName.trim());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * 
   * @param {array} [parameters.hostNames] The fully qualified domain name for
   * web site. Only one host name can be specified in the azurewebsites.net
   * domain. The host name should match the name of the web site. Custom
   * domains can only be specified for Shared or Standard web sites.
   * 
   ...
   * the web site. This value should be Shared for the Free or Paid Shared
   * offerings or Dedicated for the Standard offering. The default value is
   * Shared. If you set ComputeMode to Dedicated, you must specify a value for
   * the ServerFarm element.
   * 
   * @param {string} [parameters.serverFarm] The name of the Server Farm
   * associated with this web site. This is a required value for Standard mode.
   * 
   * @param {WebSiteMode} [parameters.siteMode] The web site mode. This value
   * is Limited for the Free offering and Basic for the Paid and Shared
   * offerings. The default value is Limited. Note: Standard mode does not use
   * the SiteMode setting; it uses the ComputeMode setting. For more
   * information, see Upgrade or Downgrade a Web Site.
   * 
   * @param {string} parameters.webSpaceName The name of the web space.
   * 
  ...
  WebSiteOperations.prototype.create = function(webSpaceName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
            ...
            if (isNil4 === false) {
              for (var loweredIndex5 = 0; loweredIndex5 < js2xml.getElements(responseDoc, sSLCertificatesSequenceElement, 'CERTIFICATE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex5 = loweredIndex5 + 1) {
                ...
                if (pfxBlobElement) {
                  ...
                  if (isNil11 === false) {
                    var pfxBlobInstance = new Buffer(pfxBlobElement, 'base64').toString('utf8');
  ...
  WebSiteOperations.prototype.createRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/repository';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.delete = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '?';
  ...
  WebSiteOperations.prototype.generatePassword = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/newpassword';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getConfiguration = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/config';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
    ...
    return this.client.pipeline(httpRequest, function (err, response, body) {
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (siteConfigElement) {
          ...
          if (remoteDebuggingVersionElement && (remoteDebuggingVersionElement === null || remoteDebuggingVersionElement === undefined || remoteDebuggingVersionElement.length === 0) === false) {
            var isNil = false;
  ...
  WebSiteOperations.prototype.getHistoricalUsageMetrics = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/metrics?';
  ...
  WebSiteOperations.prototype.getInstanceIds = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/instanceids';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getPublishProfile = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/publishxml';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.getUsageMetrics = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/usages';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.isHostnameAvailable = function(webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?';
    url2 = url2 + 'ishostnameavailable=' + encodeURIComponent(webSiteName.trim());
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.restart = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/restart';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSiteOperations.prototype.swapSlots = function(webSpaceName, webSiteName, sourceSlotName, targetSlotName, callback) {
    ...
    return client2.webSites.beginSwapingSlots(webSpaceName, webSiteName, sourceSlotName, targetSlotName, function (err, result) {
      if (err) {
        return callback(err);
      }
  ...
  WebSiteOperations.prototype.syncRepository = function(webSpaceName, webSiteName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim() + '/sites/' + webSiteName.trim() + '/repository?action=sync';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
   ...
   * state of the availability of management information for the web site.
   * Possible values are Normal or Limited. Normal means that the web site is
   * running correctly and that management information for the web site is
   * available. Limited means that only partial management information for the
   * web site is available and that detailed web site information is
   * unavailable.
   * 
   * @param {WebSiteComputeMode} [parameters.computeMode] The Compute Mode for
   * the web site. Possible values are Shared or Dedicated.
   * 
   * @param {boolean} [parameters.enabled] Indicates if the site is enabled.
   * Setting this value to false disables the site (takes the site offline).
   * 
   * @param {array} [parameters.hostNameSslStates] SSL states bound to the web
   * site.
   * 
   ...
   * [parameters.runtimeAvailabilityState] The current runtime availability
   * state. Possible values are Normal, Degraded, or NotAvailable: Normal: the
   ...
   * instance). Not Available: due to an unexpected issue, the web site has
   * been excluded from provisioning. This typically occurs only for free
   * sites.
   * 
   ...
   * web site mode is Shared, this value is Basic. Note: The SiteMode value is
   * not used for Reserved mode. Reserved mode uses the ComputeMode setting.
   * 
            ...
            if (isNil4 === false) {
              for (var loweredIndex7 = 0; loweredIndex7 < js2xml.getElements(responseDoc, sSLCertificatesSequenceElement2, 'CERTIFICATE', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex7 = loweredIndex7 + 1) {
                ...
                if (pfxBlobElement2) {
                  ...
                  if (isNil11 === false) {
                    var pfxBlobInstance = new Buffer(pfxBlobElement2, 'base64').toString('utf8');
                    certificateInstance.pfxBlob = pfxBlobInstance;
                  }
                }
   ...
   * 
   * @param {array} [parameters.connectionStrings] Connection strings for
   * database and other external resources.
   * 
   * @param {array} [parameters.defaultDocuments] Elements that list, in order
   * of preference, the name of the file that a web site returns when the web
   ...
   * 
   * @param {boolean} [parameters.detailedErrorLoggingEnabled] Indicated if
   ...
   * 
   * @param {string} [parameters.phpVersion] The web site's PHP version.
   ...
   * 
   * @param {string} [parameters.publishingUserName] The user name used for
  ...
  WebSiteOperations.prototype.updateConfiguration = function(webSpaceName, webSiteName, parameters, callback) {
    ...
    if (parameters.requestTracingExpirationTime) {
      ...
      js2xml.setElementValue(requestTracingExpirationTimeElement, parameters.requestTracingExpirationTime.toISOString());
...
var WebSpaceOperations = ( /** @lends WebSpaceOperations */ function() {
  ...
  WebSpaceOperations.prototype.createPublishingUser = function(username, password, parametersOrCallback, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=publishingCredentials';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSpaceOperations.prototype.get = function(webSpaceName, callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces/' + webSpaceName.trim();
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSpaceOperations.prototype.getDnsSuffix = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=dnssuffix';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
  ...
  WebSpaceOperations.prototype.listGeoRegions = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=georegions';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
      ...
      return xml.parseString(responseContent, options, function (err2, responseDoc) {
        ...
        if (geoRegionsSequenceElement) {
          for (var loweredIndex1 = 0; loweredIndex1 < js2xml.getElements(responseDoc, geoRegionsSequenceElement, 'GEOREGION', 'HTTP://SCHEMAS.MICROSOFT.COM/WINDOWSAZURE').length; loweredIndex1 = loweredIndex1 + 1) {
            ...
            if (sortOrderElement && (sortOrderElement === null || sortOrderElement === undefined || sortOrderElement.length === 0) === false) {
              var isNil = false;
  ...
  WebSpaceOperations.prototype.listPublishingUsers = function(callback) {
    ...
    // Construct URL
    var url2 = '/' + (this.client.credentials.subscriptionId ? this.client.credentials.subscriptionId.trim() : '') + '/services/WebSpaces?properties=publishingUsers';
    var baseUrl = this.client.baseUri;
    // Trim '/' character from the end of baseUrl and beginning of url.
    if (baseUrl[baseUrl.length - 1] === '/') {
      baseUrl = baseUrl.substring(0, (baseUrl.length - 1) + 0);
